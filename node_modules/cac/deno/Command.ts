import CAC from "cac/deno/CAC.ts";
import Option, { OptionConfig } from "cac/deno/Option.ts";
import { removeBrackets, findAllBrackets, findLongest, padRight, CACError } from "cac/deno/utils.ts";
import { platformInfo } from "cac/deno/deno.ts";
